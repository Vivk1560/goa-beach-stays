...
export function HeroSection() {
  ...
  return (
    <section className="relative flex h-[80vh] min-h-[480px] items-center justify-center text-center md:h-screen">
      <Image src="https://res.cloudinary.com/ownuvi2y/image/upload/v1788636569/goa-other/homepage/hero.png" alt="Beachfront villa in Goa" fill priority sizes="100vw" className="object-cover" />
